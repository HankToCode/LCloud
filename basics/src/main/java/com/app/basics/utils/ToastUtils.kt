...
import com.app.basics.utils.Util.Companion.getContext
...
class ToastUtils private constructor() {
    companion object {
        ...
        private var yOffset = (64 * getContext().resources.displayMetrics.density + 0.5).toInt()
        ...
        private fun show(@StringRes resId: Int, duration: Int) {
            show(getContext().resources.getText(resId).toString(), duration)
        }
        ...
        private fun show(@StringRes resId: Int, duration: Int, vararg args: Any?) {
            show(String.format(getContext().resources.getString(resId), *args), duration)
        }
        ...
        private fun show(text: CharSequence, duration: Int) {
            ...
            if (!isCustom) {
                sToast = if (messageColor != DEFAULT_COLOR) {
                    ...
                    Toast.makeText(getContext(), spannableString, duration)
                } else {
